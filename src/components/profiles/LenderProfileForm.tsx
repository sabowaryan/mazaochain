...
export function LenderProfileForm() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.availableFunds.trim()) {
      ...
      isNaN(Number(formData.availableFunds)) ||
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (existingProfile) {
        ...
        // Create new profile
        result = await supabase.from("lender_profiles").insert([profileData]);
      }
        ...
        <CardHeader>
          ...
          <CardDescription>
            {existingProfile
              ...
              : "Complétez votre profil de prêteur institutionnel"}
          </CardDescription>
        </CardHeader>
        <CardContent>
